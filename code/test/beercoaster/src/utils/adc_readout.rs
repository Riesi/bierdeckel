...
use esp_hal::{analog::adc::{self, Adc, AdcPin}, peripherals::{ADC1, GPIO4}};
...
pub async fn adc_task(adc1: Adc<'static, esp_hal::peripherals::ADC1<'static>, Blocking> , pin: AdcPin<GPIO4<'static>, esp_hal::peripherals::ADC1<'static>>) {
    let mut factor = 1f32;
    loop {
